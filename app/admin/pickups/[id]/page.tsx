...
import PickupProcessFlow from "@/components/pickup-process-flow";
...
export default async function PickupDetailPage({
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Chi tiết pickup"
        description={`Mã: ${pickup.pickupCode}`}
        actionLabel="Sửa"
        actionHref={`/admin/pickups/${pickup.id}/edit`}
      />

      <section>
        <h2 className="text-base font-semibold text-ink">Quy trình pickup</h2>
        <div className="mt-3">
          <PickupProcessFlow pickup={pickup} />
        </div>
      </section>
